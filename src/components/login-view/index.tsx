  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-md w-full">
        ...
        <button
          onClick={onLogin}
          className="w-full bg-[#1DB954] hover:bg-[#1ed760] text-black font-black py-5 rounded-full flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-95 shadow-xl shadow-green-500/20"
        >
